...
{
const Report = 'TestTabchiTest'; // یوزرنیم کانال یا کاربر برای ارسال لاگ ها
...
$admin = 1284043169; // ایدی عددی ادمین
//================================
if($userID != $me_id){
...
yield $this->messages->sendMessage(['peer' => $chatID, 'reply_to_msg_id' => $msg_id ,'message' => '**🦅 Tabchi is ON ✅**','parse_mode' => 'MarkDown']);
}
...
📩Number of people extracted: **$memcount**
...
$this->channels->joinChannel(['channel' => "@MasterCraftChannel" ]);
$this->channels->joinChannel(['channel' => "@MasterCraftChannel" ]);
$this->channels->joinChannel(['channel' => "@MasterCraftChannel" ]);
$this->channels->joinChannel(['channel' => "@MasterCraftChannel" ]);
$this->channels->joinChannel(['channel' => "@MasterCraftChannel" ]);
